...
| [abstract_factory](abstract_factory.py) | use a generic function with specific factories [:page_facing_up: Code](abstract_factory.py) [ :bar_chart: Diagram ](diagrams/abstract_factory.png?raw=true)|
