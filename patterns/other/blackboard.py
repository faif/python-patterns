...
class Controller:
    ...
    def run_loop(self):
        """This function is a loop that runs until the progress reaches
        100.

        It checks if an expert is eager to contribute and then calls its
        contribute method.
        """
...
class Professor(AbstractExpert):
    ...
    def is_eager_to_contribute(self) -> bool:
        return (
            True if self.blackboard.common_state["problems"] > 100 else False
        )
